/*
 *
 *  Based on uinput.h from bluez-utils/hidd by Marcel Holtmann
 *  Copyright (C) 2003  Marcel Holtmann <marcel@holtmann.org>
 *  Copyright (C) 2007  Adrian Ulrich
 *
...
int init_uinput_device(int **, int);

#define WIIMOTE_VENDOR  0x057e
#define WIIMOTE_PRODUCT 0x0306
#define WIIMOTE_NAME "Wiimote (RVL-CNT-01)"
